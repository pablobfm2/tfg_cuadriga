...
FixpositionDriverNode::FixpositionDriverNode(std::shared_ptr<rclcpp::Node> node, const FixpositionDriverParams& params)
    : FixpositionDriver(params),
      node_(node),
      rawimu_pub_(node_->create_publisher<sensor_msgs::msg::Imu>("cuadriga/fixposition/rawimu", 100)),
      corrimu_pub_(node_->create_publisher<sensor_msgs::msg::Imu>("cuadriga/fixposition/corrimu", 100)),
      navsatfix_pub_(node_->create_publisher<sensor_msgs::msg::NavSatFix>("cuadriga/fixposition/navsatfix", 100)),
      navsatfix_gnss1_pub_(node_->create_publisher<sensor_msgs::msg::NavSatFix>("cuadriga/fixposition/gnss1", 100)),
      navsatfix_gnss2_pub_(node_->create_publisher<sensor_msgs::msg::NavSatFix>("cuadriga/fixposition/gnss2", 100)),
      odometry_pub_(node_->create_publisher<nav_msgs::msg::Odometry>("cuadriga/fixposition/odometry", 100)),
      poiimu_pub_(node_->create_publisher<sensor_msgs::msg::Imu>("cuadriga/fixposition/poiimu", 100)),
      vrtk_pub_(node_->create_publisher<fixposition_driver_ros2::msg::VRTK>("cuadriga/fixposition/vrtk", 100)),
      odometry_enu0_pub_(node_->create_publisher<nav_msgs::msg::Odometry>("cuadriga/fixposition/odometry_enu", 100)),
      eul_pub_(node_->create_publisher<geometry_msgs::msg::Vector3>("cuadriga/fixposition/ypr", 100)),
      eul_imu_pub_(node_->create_publisher<geometry_msgs::msg::Vector3>("cuadriga/fixposition/imu_ypr", 100)),
